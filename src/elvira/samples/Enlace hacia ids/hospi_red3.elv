...
{
   values=table(
               [ Leve Ausente ] = 1.000000,
               [ Leve Presente ] = 0.000000,
               [ Grave Ausente ] = 0.000000,
               [ Grave Presente ] = 0.7,
               [ MuyGrave Ausente ] = 0.000000,
               [ MuyGrave Presente ] = 0.3);
}
...
{
  kind-of-relation=constraint;
  values=logical-expression(Terapia2 in {Fot6ExaFot6,Fot6ExaFot12} -> Terapia1 in {Fot24});
