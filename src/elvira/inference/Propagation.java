...
/**
 * Vector containing all the new potentials generated
 * during the evaluation. It is used for debuging purposes.
 * It is controled with saveGenPots variable
 */
protected Vector<Potential> generatedPots = null;

protected Vector<String> strGenPot = null;

protected boolean saveGenPots = false;
  ...
  public void setInterest(NodeList vars) {
    ...
    public Vector<Potential> getGeneratedPots() {
        return generatedPots;
    }

    public void setGeneratedPots(Vector<Potential> generatedPots) {
        this.generatedPots = generatedPots;
    }

    public boolean isSaveGenPots() {
        return saveGenPots;
    }

    public void setSaveGenPots(boolean saveGenPots) {
        this.saveGenPots = saveGenPots;
    }
 
  
    protected void addGenPotential(Potential p, String str) {
        if(this.saveGenPots){
            if(this.generatedPots==null) {
                generatedPots = new Vector<Potential>();
                strGenPot = new Vector<String>();
    ...
    protected void addGenPotential(Potential p) {
        addGenPotential(p, "");

    }

    public Vector<String> getStrGenPot() {
        return strGenPot;
    }
  ...
  public RelationList getInitialRelations() {
   ...
   //    System.out.println("varaibles que afectan " + varAffecting.size());
     ...
     /**
   * Transforms one of the original Potential. In this
   * case no transformation is carried out. This method can be
   * overloaded for special requirements.
   * @param p the <code>Potential</code> to be transformed.
   * @return The new transformed Potential
   */
  public Potential transformInitialRelation(Potential p) {
    return p;
  }
   ...
   * @return The new transformed Potential
   */
  public Potential transformExpectedUtility(Potential p) {
    return p;
  }
  /**
  ...
  public void eraseRelationCache() {
  ...
  public void printResults(){
    ...
    //  System.out.println(((PotentialTable)pot).getValue((int)pot.getNumConfigurations()-1));
