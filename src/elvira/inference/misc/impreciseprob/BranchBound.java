 ...
 * @author Manuel GÃ³mez Olmedo (mgomez@decsai.ugr.es)
 */
  ...
  public void propagate(String resultFile)  throws IOException{
    ...
    for(int i=0;i<n;i++){
      ...
      for(int j=0;j<var.getNumStates();j++){
        System.out.println("OPTIMIZANO CASO Nï¿½MERO "+j);
        ...
        System.out.println("\n\nNodos Visitados para el mï¿½ximo: "+visitedNodes+"\n\n");
        ...
        System.out.println("\n\nNodos Visitados para el mï¿½nimo: "+visitedNodes+"\n\n");
