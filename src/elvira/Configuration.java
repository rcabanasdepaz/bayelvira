...
public Configuration(Configuration conf1, Configuration conf2) {
   ...
   //Initialize the node list with the vars in conf1 or conf2
   
   for(i=0; i<conf1.getVariables().size(); i++) {
       Node n = (Node) conf1.getVariables().elementAt(i);      
       if(nl.getId(n)==-1)
           nl.insertNode(n);
   }  
   for(i=0; i<conf2.getVariables().size(); i++) {
       Node n = (Node) conf2.getVariables().elementAt(i);      
       if(nl.getId(n)==-1)
           nl.insertNode(n);
   } 
