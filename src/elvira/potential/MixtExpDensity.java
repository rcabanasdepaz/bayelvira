...
public class MixtExpDensity implements Serializable {
    ...
    */
    ...
    public MixtExpDensity integral(Continuous var, double x1, double x2, int flag) {
        ...
        //  System.out.println("Integral Extraï¿½a:"+var.getName()+","+x1+","+x2);
 ...
 * function is intro a pï¿½renthesis.
 */
  ...
  /*if (getIndependent()==0.0)
    ...
    public boolean checkData(Vector X, Vector Y){
        ...
        // The first point
        //System.out.println("Estoy en CheckData, line 1570. EL tamaï¿½o de X es: "+X.size());
...
//                    }
                    ...
                    if(ultimoValue < 0 ){
                        ...
                        //Ahora no tiene sentido calcular un H, porque sï¿½lo hay un H que cumple que
                        // la funciï¿½n pase por (x0,y0/1000), y es uno por como hemos calculado antes los parametros.
...
//                    }
            ...
            if (newerror >= lasterror ) {
                ...
                if((primeroValue > 0) && (ultimoValue > 0)){
                    ...
                    //Por si los dos son negativos, vamos a ver cual es el mas pequeï¿½o y ese es el q se modifica:
                    if ((primeroValue < 0)&&(ultimoValue < 0 )){
                        if (primeroValue < ultimoValue) ultimoValue = 0;
                        else primeroValue = 0;
                        //System.out.println("El primero y el ultimo son negativos");
...
public void simplify2(){
  ...
  for(i=0 ; i < terms.size() ; i++){
    ...
    public MixtExpDensity prune2Leaf(ContinuousIntervalConfiguration conf ){
       ...
       //  System.out.println("Nï¿½mero de tï¿½rminos exponenciales: "+tam);
        if(tam > 0){// Ahora miro a ver cuï¿½l es la vble que aparece en la MTE, y miro los
       ...
       //      System.out.println("Hay mas de tres: "+tam);
            ...
            // Ahora ya sabemos cuï¿½l es el tï¿½rmino a eliminar.
            
         //    System.out.println("Hay que eliminar el tï¿½rmino de la posiciï¿½n "+toRemove);
            ...
            // HACIENDOLO ASï¿½ HAY UN PROBLEMA, Y ES QUE SALE NEGATIVO A VECES, ASI QUE SE LO 
            ...
            // sumar el mï¿½ximo valor del tï¿½rmino que eliminamos (siempre que tenga peso positivo)
