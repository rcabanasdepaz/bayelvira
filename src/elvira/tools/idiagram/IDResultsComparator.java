...
//System.out.println("Polï¿½ticas ï¿½ptimas de referencia: ");
//reference.print();
//System.out.println();
//System.out.println("Polï¿½ticas ï¿½ptimas de la propagaciï¿½n : ");
//propagation.print();
//System.out.println("----------------------------------------------");
...
//System.out.println("Comparando polï¿½ticas globales....... ("+index+")");
...
//progUtilPot.print();
//System.out.println("-------------------------------------------");
//System.out.println("Polï¿½tica de referencia.....................");
//reference.print();
//System.out.println("-------------------------------------------");
//System.out.println("Polï¿½ticas de propagaciï¿½n...................");
//propagation.print();
//System.out.println("-------------------------------------------");
...
System.out.println("Analizando caso: "+i);
 ...
 public static void main(String args[]) throws ParseException, IOException{
    if (args.length < 1){
      ...
      propagation.setThresholdForPruningProb(0.7);
