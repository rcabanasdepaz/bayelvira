...
//      if (Double.isNaN(z))      System.out.println("multiplico "+x+" por "+((Double) coefficients.elementAt(pos)).doubleValue()+" nï¿½coefici "+coefficients.size());
    return z;
  }
}
...
public void simplifyT(){
  ...
  double coef1; 
  double coef2;
  //System.out.println("ï¿½ simplifico este LinearFunction?");
  //print();
