...
super("Árbol de Directorios");
setSize(350, 250);

DefaultMutableTreeNode top = new DefaultMutableTreeNode(new IconData(ICON_COMPUTER, null, "Raíz"));
...
{
m_tree.repaint();
JOptionPane.showMessageDialog(FileTree.this,"Delete option is not implemented","Info",JOptionPane.INFORMATION_MESSAGE);}};
m_popup.add(a1);
...
(FileTree.this,"Rename option is not implemented","Info",JOptionPane.INFORMATION_MESSAGE);
}
};
...
public void mouseClicked(MouseEvent e){
    ...
    if (e.getClickCount()==2){
         auxiliar=getFileNode(getTreeNode(m_tree.getSelectionPath()));
         if ((esfichero)&&(auxiliar!=null)){
            System.out.println(auxiliar.getFile().getPath());
            Ruta=auxiliar.getFile().getPath();
            dispose();
         }
    }
...
public void paintComponent(Graphics g)
{
    ...
    g.drawRect(offset, 0, getWidth()-1-
    offset, getHeight()-1);
    }
...
public IconData(Icon icon, Icon expandedIcon, Object
data)
{
m_icon = icon;
...
{
return m_expandedIcon!=null ? m_expandedIcon :
m_icon;
}
...
(FileTree.ICON_FOLDER,
FileTree.ICON_EXPANDEDFOLDER,
nd);
